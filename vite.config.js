...
export default defineConfig(({ command, mode }) => {
  ...
  const defaultBase = command === 'build' ? '/CV-Online/' : '/'

  return {
    // Em produção (GitHub Pages) o site é servido em /CV-Online/ por omissão.
    // Define VITE_BASE_PATH para publicar noutro domínio/subdiretório.
