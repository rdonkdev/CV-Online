  ...
  <div class="space-y-4">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      <div>
        ...
        <input id="p-phone" v-model="p.phone" class="input" placeholder="+258 84 123 4567" />
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div>
        ...
        <input id="p-location" v-model="p.location" class="input" placeholder="Maputo, Moçambique" />
      </div>
      <div>
