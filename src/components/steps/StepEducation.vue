<template>
  <div class="space-y-4">
    ...
    <p v-if="!cv.education.length" class="empty-hint">Ainda sem formação. Adiciona a primeira.</p>

    <div v-for="(edu, i) in cv.education" :key="edu.id" class="field-card p-4">
      ...
      <p
        v-if="edu.startDate && edu.endDate && edu.endDate < edu.startDate"
